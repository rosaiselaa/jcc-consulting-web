...
import { AdvancedAiSection } from "@/components/sections/AdvancedAiSection";
import { EnterpriseToolsSection } from "@/components/sections/EnterpriseToolsSection";
      ...
      <footer className="bg-background border-t border-border py-8">
        <div className="container mx-auto px-6 max-w-7xl flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} JCC Consulting. Todos los derechos
            reservados.
          </p>
        </div>
      </footer>
